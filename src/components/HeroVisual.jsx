...
export default function HeroVisual() {
  ...
  return (
    ...
    >
      ...
      <motion.div onMouseMove={handleMove} onMouseLeave={() => { rotateX.set(0); rotateY.set(0) }} style={{ rotateX: smoothRotateX, rotateY: smoothRotateY, transformStyle: 'preserve-3d' }} className="absolute inset-4 overflow-hidden rounded-[2rem] border border-white/15 bg-panel shadow-2xl shadow-black/70 will-change-transform sm:inset-5">
        <img src="/images/murilo-dutra.jpeg" alt="Murilo Dutra, desenvolvedor web em Canoas" width="536" height="954" decoding="async" fetchPriority="high" className="h-full w-full object-cover object-[center_30%] saturate-[.75] contrast-[1.08]" />
